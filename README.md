...
Due to relatively complexity, Uniview recently dropped committment to white-labelling and cpanel alike personal clouds. Uniview can go in quick manner, but white-labelling way of hit-ground to go is not Uniview top value. However for non-enterprise and just get-started, in case partnership is important, Uniview is still a good choice.  
